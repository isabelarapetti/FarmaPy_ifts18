...
def buscar():
    ...
    if usuario_autenticado:
        ...
        if tipoConsulta == 'pmv' or tipoConsulta == 'cmg':
            ...
            filtroBusqueda = str(request.form.get('filtroBusqueda'))
# si la consulta es distinta el filtroBusqueda debera recibir un dato para comparar si esta en
# el csv asi se podra realizar la vista de la consulta.
